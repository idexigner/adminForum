                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="table-responsive">
                        <table id="tbl_projects" class="display expandable-table" style="width:100%">
                          <thead>
                            <tr>
                              <th>ID</th>
                              <th>Title</th>
                      ...
                      foreach ($projects as $pro) { ?>
                                <tr>
                                  <td><a href="<?php echo base_url(); ?>projects/get/<?php echo $pro->pro_id; ?>"><?php echo $pro->pro_id; ?></a></td>
                                  <td><?php echo $pro->pro_title; ?></td>
                                  <td><?php echo $pro->pro_business_owner; ?></td>
                                  <td><?php echo $pro->pro_point_of_contact; ?></td>
                                  <td><?php echo $pro->pro_budget; ?></td>
                                  <td><?php echo $pro->pro_created; ?></td>
                                </tr>
                        <?php }
                        ?>   
