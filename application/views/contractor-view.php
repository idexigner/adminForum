         ...
         <div class="content-wrapper">
            <div class="row">
               <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                           <div class="card-body">
                              <p class="card-title float-right"><span class="badge badge-primary float-right">Contractor</p>
                              <div class="d-flex">
                                 <img src="<?php echo base_url(); ?>assets/images/faces/face1.jpg" alt="user" class="rounded">
                                 <div class="ml-3">
                                    <p class="text-info mb-1"><?php echo $contractor->user_username; ?></p>
                                    <p class="mb-0">Fullname: <?php echo $contractor->user_fullname; ?></p>
                                    <small>Email: <?php echo $contractor->user_email; ?></small>
                                 </div>
                              </div>
                           </div>
                        </div>
