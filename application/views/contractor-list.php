      ...
      <div class="main-panel">        
        <div class="content-wrapper">
          ...
          <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Contractors</p>
                  <div class="row">
                    <div class="col-12">
                      ...
                      foreach ($contractors as $cont) { ?>
                                <tr>
                                  <td><a href="<?php echo base_url(); ?>contractor/get/<?php echo $cont->user_id; ?>"><?php echo $cont->user_id; ?></a></td>
                                  <td><?php echo $cont->user_fullname; ?></td>
                                  <td><?php echo $cont->user_username; ?></td>
                                  <td><?php echo $cont->user_email; ?></td>
                                </tr>
                        <?php }
                        ?>   
