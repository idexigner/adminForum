            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Proposal > <?php echo $pro->pro_title; ?></h3>
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="<?php echo base_url(); ?>contractorpages/proposals/send_submit">
                  
                    <div class="form-group">
                      <label for="exampleTextarea1">Describe your offer:</label>
                      <textarea class="form-control" placeholder="Description" id="exampleTextarea1" name="prop_desc" rows="4"><?php echo set_value('prop_desc'); ?></textarea>
                      <span class="helper-text"><?php echo form_error('prop_desc'); ?></span>
                    </div>

                    <div class="form-group">
                        <label for="exampleTextarea1">Bid Amount</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-primary text-white">$</span>
                            </div>
                            <input type="text" class="form-control" name="prop_bid_amount" value="<?php echo set_value('prop_bid_amount'); ?>" id="exampleInputUsername1" placeholder="1500">
                        </div>
                        <span class="helper-text"><?php echo form_error('prop_bid_amount'); ?></span>
                    </div>

                    <input type="hidden" name="prop_pro_id" value="<?php echo $pro->pro_id; ?>">
