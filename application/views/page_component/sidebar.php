...
<div class="left side-menu">
    ...
    <div class="topbar-left">
        <div class="text-center bg-logo">
            ...
            <a href="index.html" class="logo"><img src="<?= base_url(); ?>assets/images/logo.png" height="50" alt="logo"></a>
        </div>
    </div>
    <div class="sidebar-user">
        <img src="<?= base_url(); ?>assets/images/faces/face1.jpg" alt="user" class="rounded-circle img-thumbnail mb-1">
        <h6 class=""> <?= $this->session->userdata('loggedUser_Admin')['user_fullname']?> </h6> 
        ...
        <ul class="list-unstyled list-inline mb-0 mt-2">
            ...
            <li class="list-inline-item">
                <a href="<?=base_url()?>signout" class="" data-toggle="tooltip" data-placement="top" title="Log out"><i class="dripicons-power text-danger"></i></a>
            </li>
        </ul>           
    </div>
    ...
    <div class="sidebar-inner slimscrollleft">
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="fas fa-user"></i><span> User </span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                    <ul class="list-unstyled">                                    
                        <li><a href="<?=base_url()?>user/create">Add User</a></li>
                        <li><a href="<?=base_url()?>user">Users List</a></li>
