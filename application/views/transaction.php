                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="card">
                                        <div class="card-body table-responsive">
                                            ...
                                            <div class="">
                                                <table id="datatable_transaction" class="table table-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                    <thead>
                                                    <tr>
                                                        <th>Id</th>
                                                        <th>User</th>                                                       
                                                    ...
                                                    <tbody>
                                                    <?php foreach($transaction_list as $t){ ?>
                                                    <tr>
                                                        <td><?=$t->t_id?></td>
